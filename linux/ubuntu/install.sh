...
debootstrap --arch amd64 bionic ${BASE} http://ch.archive.ubuntu.com/ubuntu/
...
auto eth0
 iface eth0 inet static
  address 194.50.111.111/24
  gateway 194.50.111.254
 iface eth0 inet6 static
  address 2a09:4c0:c232:6f6f::/64
  gateway 2a09:4c0:c232:6ffe::
EOF
...
chroot "${BASE}" apt -y install grub-pc linux-image-generic locales lvm2 ssh
